...
class SectorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create sector" do
    assert_difference('Sector.count') do
      post sectors_url, params: { sector: { departamento_id: @sector.departamento_id, nombre: @sector.nombre, numero_maximo_votantes: @sector.numero_maximo_votantes } }
    end
  ...
  test "should update sector" do
    patch sector_url(@sector), params: { sector: { departamento_id: @sector.departamento_id, nombre: @sector.nombre, numero_maximo_votantes: @sector.numero_maximo_votantes } }
